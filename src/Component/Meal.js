    ...
    return(
        ...
        <div className="flex flex-col lg:flex-row justify-center">
            <div className="flex items-center justify-center md:justify-center">
                ...
                <button onClick={()=>fillterCat("pizza")} className="m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700">Pizza</button>
                <button onClick={()=>fillterCat("chicken")} className="m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700">Chicken</button>
                ...
                foods.map((item) => {
                    return(
                        <div key={item.id} className="border-none hover:scale-105 duration-300">
                            ...
                            <img className= "h-[200px] w-full object-cover rounded-lg" src={item.image} alt={item.name} />
                           ...
                           <div className="pl-2 py-3 -mt-7">
                            <p className="flex item-center text-indigo-600">View More<ArrowSmRightIcon className="w-5 ml-2"></ArrowSmRightIcon></p>
                           </div>
                        </div>
                    )
                    })
